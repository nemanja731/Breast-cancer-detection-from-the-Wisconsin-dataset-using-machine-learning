...
def train_and_classify(dataset, classifier, name, filename):
    ...
    for train_index, test_index in folds.split(X, y):
        ...
        # make_report(prediction, y_test, name, filename, i)
...
# pravljenje izvestaja za 1 stablo odluke u toku procesa
def make_report(prediction, y_test, name, filename, i):
    if (i != 1):
        print("\n-----------------------\n")
...
if __name__ == "__main__":
    ...
    # podela skupa podataka, treniranje i klasifikacija razlicitim metodama
    classify(dataset)